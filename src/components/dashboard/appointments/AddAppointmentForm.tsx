      ...
      <div className="space-y-6">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-sm text-right outline-none"
          />
        </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-2 justify-center">
            <input
              ...
              placeholder="۰۴"
              className="w-20 px-3 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-sm text-center outline-none"
              dir="ltr"
            />
