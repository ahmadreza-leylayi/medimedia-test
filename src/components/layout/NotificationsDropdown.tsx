...
export function NotificationsDropdown() {
  ...
  if (!isMounted || !user) {
    return (
      <div className="relative shrink-0" suppressHydrationWarning>
        <div className="relative w-10 h-10 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center transition-colors">
          <svg
  ...
  return (
    <div className="relative shrink-0" ref={dropdownRef} suppressHydrationWarning>
      <button
